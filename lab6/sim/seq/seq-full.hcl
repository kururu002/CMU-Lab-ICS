...
bool instr_valid = icode in 
	{ INOP, IHALT, IRRMOVL, IIRMOVL, IRMMOVL, IMRMOVL,
	       IOPL,IIADDL, IJXX, ICALL,ILEAVE, IRET, IPUSHL, IPOPL, ILEAVE};
#ADD IILEAVE and IIADDL
...
int srcB = [
	icode in { IOPL, IRMMOVL, IMRMOVL ,IIADDL } : rB;#IIADDL take rB here
...
int dstE = [
	...
	icode in { IIRMOVL, IOPL, IIADDL} : rB;#same as srcB
...
int dstM = [
	...
	icode in { ILEAVE}:REBP;#ILEAVE needs to work on frame pointer
	1 : RNONE;  # Don't write any register
];
